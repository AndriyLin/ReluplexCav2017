...
int main( int argc, char **argv )
{
    ...
    // Check that every other index has smaller score than 1950s (category 0)
    unsigned targetOutputVariableIndex;
    // This is the contender
    unsigned otherOutputVariableIndex = 0;  // for 1950s
    ...
    targetOutputVariableIndex = atoi( argv[1] );

    if ( ( otherOutputVariableIndex == targetOutputVariableIndex ) ||
         ( targetOutputVariableIndex >= 4 ) )
    {
